...
namespace AerSpeech
{
    ...
    public class NMKeyboard
    {
        ...
        public NMKeyboard(int inputDelay = 10)
        {
        ...
        public void Type(string typeMe)
        {
            ...
            foreach (char c in characters)
            {
                ...
                {
                    NMDebug.LogError("ScanCode for character '" + c + "' does not exists in dictionary");
                }
        ...
        public void ClearField()
        {
            for (int i = 0; i < 60; i++)
            {
                ...
                {
                    NMDebug.LogError("ScanCode for backspace character does not exists in dictionary");
                }
